              ...
              <div className="flex flex-col items-center lg:items-start">
                <div className="text-content">
                  ...
                  <p className="pb-4 max-w-[480px] text-lg text-left">
                    I'm a 3rd-year BTech graduate and a Full Stack Developer
                    with a passion for innovation.I specialize in building
                    captivating and responsive full stack websites that bridge
                    creativity and functionality. Let's turn visions into
                    reality and reimagine the digital landscape together! 🚀🌐
                  </p>
                </div>
              </div>
            </div>
